...
![Version: 1.2.39](https://img.shields.io/badge/Version-1.2.39-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.3](https://img.shields.io/badge/AppVersion-8.3-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| kafka.container.envList[0].key | string | `"DATA"` |  |
| kafka.container.envList[0].value | string | `"/home/kafka/zk_data"` |  |
| kafka.container.image.repoSecret.dockerRegistry.auths."docker.share.cloud.k2view.com".password | string | `""` |  |
| kafka.container.image.repoSecret.dockerRegistry.auths."docker.share.cloud.k2view.com".username | string | `""` |  |
| kafka.container.image.repoSecret.enabled | bool | `false` |  |
| kafka.container.image.repoSecret.name | string | `"registry-secret"` |  |
| kafka.container.image.url | string | `"329508970117.dkr.ecr.eu-central-1.amazonaws.com/k2view_shared:kafka_7.2"` |  |
| kafka.container.replicas | int | `1` |  |
| kafka.container.resource_allocation.limits.cpu | string | `"1"` |  |
| kafka.container.resource_allocation.limits.memory | string | `"4Gi"` |  |
| kafka.container.resource_allocation.requests.cpu | string | `"0.4"` |  |
| kafka.container.resource_allocation.requests.memory | string | `"2Gi"` |  |
| kafka.labels[0].name | string | `"tenant"` |  |
| kafka.labels[0].value | string | `"my-tenant"` |  |
| kafka.labels[1].name | string | `"space"` |  |
| kafka.labels[1].value | string | `"my-space"` |  |
| kafka.listening_port | int | `9093` |  |
